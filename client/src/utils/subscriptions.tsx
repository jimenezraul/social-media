...
export const NEW_LIKE_NOTIFICATION_SUBSCRIPTION = gql`
  subscription New_Like_Notification_Subscription($userId: ID!) {
    newLikeNotificationSubscription(userId: $userId) {
      _id
      is_read
      message
      postId
